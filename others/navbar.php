...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Palette+Mosaic&family=Style+Script&display=swap"
        rel="stylesheet">
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
    ...
    <div class="sourav">
        <!-- <a href="cart.php" style="margin: 24px" class="btn btn-outline-success">My Cart (0)</a><br> -->
    </div>
</div>
